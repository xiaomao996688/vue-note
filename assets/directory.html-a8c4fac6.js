import{_ as e,o as i,c as s,d as n}from"./app-b2c60ca5.js";const a={},r=n(`<h1 id="vue-js-源码目录设计" tabindex="-1"><a class="header-anchor" href="#vue-js-源码目录设计" aria-hidden="true">#</a> Vue.js 源码目录设计</h1><p>Vue 的源码目录结构如下，核心代码都在 src 的目录下。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── dist
├── examples
├── flow
├── scripts
├── src
